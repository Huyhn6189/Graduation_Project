...
class Node:
    def __init__(self):
        ...
        # PID Params
        self.kp = [20.6, 19.5, 7.0, 7.0]
        self.ki = [7.5, 7.1, 2.0, 1.0]
        self.kd = [1.5, 0.03, 0.1, 0.05]
        ...
        # Dimension of robot 
        self.wheelSeparation = 0.4
        self.wheelSeparationLength = 100
        self.diameter_wheel = 0.095
        self.ticks_per_round = 2700
    ...
    def calculate_PID(self,stt,vel_target, vel_real,delta_time):
        ...
        if (self.duty_data[stt] > 250.0) : 
            self.duty_data[stt] = 250

        if (self.duty_data[stt] < -250) :
            self.duty_data[stt] = -250
